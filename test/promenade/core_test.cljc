...
(deftest test-reduce-as->bind-either
  (is (= 1
...
(deftest test-reduce-as->bind-maybe
  (is (= 1
        (prom/reduce-as-> prom/bind-maybe
          :foo $
          ({:foo 1
            :bar 2} $)
          [(do [2 1]) (vector $ 2)]
...
(deftest test-reduce-as->bind-trial
  (is (= 1
        (prom/reduce-as-> prom/bind-trial
          :foo $
          ({:foo 1
            :bar 2} $)
          [(do [2 1]) (vector $ 2)]
